...
public class MapForm {
    ...
    public MapForm(Trajet t) {
        ...
        cnt.setCameraPosition(new Coord(t.getLatitude(), t.getLongitude()));
        
        Button btnMoveCamera = new Button("Depart: " + t.getDepart());
        ...
        f.setTitle(t.getDepart() + " - "+ t.getDestination());
        f.setLayout(new BorderLayout());
        f.addComponent(BorderLayout.CENTER, cnt);
        f.addComponent(BorderLayout.SOUTH, btnMoveCamera);
        f.getToolbar().addCommandToLeftBar("back", null, (ev)->{ new DetailsTrajetForm(t).showBack();});
        f.show();
